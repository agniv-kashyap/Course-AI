...
const CreateCoursePage = () => {
  ...
  const generateCourse = async () => {
    console.log("Generate Course button clicked");
    ...
    try {
      let id = uuid4();
      console.log("Sending prompt to AI:", BASIC_PROMPT);
      ...
      console.log("Course saved, redirecting...");
      router.replace(`/create-course/${id}`);
    } catch (error) {
      console.log("Error in generateCourse:", error);
    } finally {
      setLoading(false);
    }
  };
